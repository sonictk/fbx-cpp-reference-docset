#!/usr/bin/env python
"""
This module is a script that cleans up the default HTML FBX Doxygen
...
def main(docs_sources, output_path, multi_thread=False, fbx_version='2016'):
    """
    ...
    :param fbx_version: ``str`` indicating what version of FBX the docset
    ...
    if not output_path:
        output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                                'fbx-{0}-cpp.docset'.format(fbx_version),
                                'Contents',
                                'Resources',
                                'Documents')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-fv',
                        '--fbxVersion',
                        type=str,
                        help='The FBX version of the docset to generate.',
                        default='2016')
